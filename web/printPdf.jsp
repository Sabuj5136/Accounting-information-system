...
<html>
    ...
    <body>
        <div class="container" style="height: 650px">
            <div style="height: 100px; background-color: #004085">
                ...
                <center>
                    <h3 style="color: whitesmoke; padding: 20px">Legacy Electronics  Ltd</h3>
                </center>
            </div>
           
            <div class="p-3 mb-2 bg-info text-white">
                <h1>PRINT THIS PDF fILE</h1>
            ...
            <div class="p-3 mb-2 bg-info text-white" style="height: 100px; border: 2px #ccc solid">
                <p style="padding: 25px">Legacy Electronics Ltd, All rights reserved.</p>
            </div>
