<%-- 
    ...
    Created on : Jun 21, 2018, 11:26:03 AM
    Author     : Rezaul sabuj
--%>
    ...
    <body>
        <div class="container" style="height: 650px">
            <div style="height: 100px; background-color: darkcyan">
                <center>
                    <h3 style="color: whitesmoke; padding: 20px">Detail's of Inventory</h3>
                </center>
            </div>
                    ...
                    <tbody>
                        <c:forEach items="${ai}" var="a">
                            <tr>
                                ...
                                <td>${a.stock}</td>
                                <td>${a.costPerUnit}</td>
                                <td>${a.totalCostPrice}</td>
                                <td>${a.salesPerUnit}</td>
                                <td>${a.totalSalesPrice}</td>
                                <td>${a.model}</td>
                                <td>${a.brand}</td>
